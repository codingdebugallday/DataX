...
import org.abigballofmud.datax.plugin.reader.otspostprocessreader.model.OTSPrimaryKeyColumn;
import org.abigballofmud.datax.plugin.reader.otspostprocessreader.model.SecretTypeEnum;
    ...
    private static ColumnValue columnDecodeHandler(Map<String, ColumnValue> values, OTSColumn col) throws IOException {
        ...
        switch (SecretTypeEnum.valueOf(col.getDecode()).getOrder()) {
            ...
            case 2:
                ...
                break;
            default:
                throw DataXException.asDataXException(OtsPostProcessReaderError.ERROR,

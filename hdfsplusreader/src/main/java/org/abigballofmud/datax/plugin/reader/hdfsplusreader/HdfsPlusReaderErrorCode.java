...
public enum HdfsPlusReaderErrorCode implements ErrorCode {
    ...
    SHELL_ERROR("HiveReader-16", "执行shell失败"),
    TMP_TABLE_NAME_ERROR("HiveReader-17", "临时表名称未配置"),
    ;
    ...
    private HdfsPlusReaderErrorCode(String code, String description) {
        this.code = code;
